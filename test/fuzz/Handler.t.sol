// This handler is going to narrow down the way we call functions - this way we don't waste runs
// e.g. we always need to approve() a coin before deposit() it, otherwise that'd bea  wasted run
...
contract Handler is Test {
    ...
    function mintDsc(uint256 amountDscToMint, uint256 addressSeed) public {
        ...
        console.log("collateralValueInUsd:", amountDscToMint);
